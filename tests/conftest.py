...
# WARNING: Ensure imports from `fastapi_fileproxy` comes after this line
from fastapi_fileproxy import app, settings, db  # noqa
from fastapi_fileproxy.cli import create_user, cli  # noqa
